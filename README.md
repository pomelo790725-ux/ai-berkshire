...
[实盘业绩](#real-track-record) · [为什么不能直接问AI](#为什么不能直接问-ai) · [Skills 一览](#skills-一览20个) · [快速开始](#快速开始) · [实战报告](#实战研究报告) · [设计理念](#设计理念) · [公众号](#实盘的下一步)
...
**三层设计哲学**：
- **Skill 层**：把"你要做什么"抽象成 20 个明确入口——深度研究、财报分析、估值建模、行业筛选、持仓管理、思维工具，按场景选用
...
| Skill | 用途 | 适合场景 |
|-------|------|---------|
| [`/dcf-comps`](skills/dcf-comps.md) | DCF+可比公司双轨估值 | 绝对估值(折现现金流)与相对估值(同业倍数)交叉验证，给出估值区间而非单一目标价 |
